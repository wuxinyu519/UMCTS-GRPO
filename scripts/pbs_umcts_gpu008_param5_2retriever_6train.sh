#!/bin/bash
#PBS -N umcts_g008_p5
#PBS -o umcts_g008_p5.out
#PBS -e umcts_g008_p5.err
...
export EXPERIMENT_NAME=singlehopqa-umcts-qwen2.5-1.5b-gpu008-param5-tau0.1-2retriever-6train
...
export UMCTS_CONFIDENCE_TAU=${UMCTS_CONFIDENCE_TAU:-0.1}
