#!/bin/bash
#PBS -N umcts_g008_p7
#PBS -o umcts_g008_p7.out
#PBS -e umcts_g008_p7.err
...
export EXPERIMENT_NAME=singlehopqa-umcts-qwen2.5-1.5b-gpu008-param7-cu0.1-ucb0.1-to60-2retriever-6train
...
export UMCTS_UNCERTAINTY_COEF=${UMCTS_UNCERTAINTY_COEF:-0.1}
export UMCTS_UCB_C=${UMCTS_UCB_C:-0.1}
export UMCTS_LOCAL_ADVANTAGE_WEIGHT=${UMCTS_LOCAL_ADVANTAGE_WEIGHT:-1.0}
...
export TRAINER_TOTAL_TRAINING_STEPS=${TRAINER_TOTAL_TRAINING_STEPS:-60}
