#!/bin/bash
#PBS -N umcts_g008_p2
#PBS -o umcts_g008_p2.out
#PBS -e umcts_g008_p2.err
...
export EXPERIMENT_NAME=singlehopqa-umcts-qwen2.5-1.5b-gpu008-param2-cu2.0-2retriever-6train
...
export UMCTS_UNCERTAINTY_COEF=${UMCTS_UNCERTAINTY_COEF:-2.0}
