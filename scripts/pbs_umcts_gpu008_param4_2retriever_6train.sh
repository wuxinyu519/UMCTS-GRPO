#!/bin/bash
#PBS -N umcts_g008_p4
#PBS -o umcts_g008_p4.out
#PBS -e umcts_g008_p4.err
...
export EXPERIMENT_NAME=singlehopqa-umcts-qwen2.5-1.5b-gpu008-param4-tau5.0-2retriever-6train
...
export UMCTS_CONFIDENCE_TAU=${UMCTS_CONFIDENCE_TAU:-5.0}
