#!/bin/bash
#PBS -N umcts_g008_p6
#PBS -o umcts_g008_p6.out
#PBS -e umcts_g008_p6.err
...
export EXPERIMENT_NAME=singlehopqa-umcts-qwen2.5-1.5b-gpu008-param6-cu0.5-ucb0.5-2retriever-6train
...
export UMCTS_UNCERTAINTY_COEF=${UMCTS_UNCERTAINTY_COEF:-0.5}
export UMCTS_UCB_C=${UMCTS_UCB_C:-0.5}
